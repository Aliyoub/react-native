...
const apiInsertNewFood = 'http://localhost:3000/foods';
const apiUpdateAFood = 'http://localhost:3000/foods';
...
async function updateAFood(params) {
    try {
        console.log("PHU");
        console.log(apiUpdateAFood + '/' + params.id);
        let response = await fetch(apiUpdateAFood + '/' + params['id'], {
            method: 'PUT',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',                
