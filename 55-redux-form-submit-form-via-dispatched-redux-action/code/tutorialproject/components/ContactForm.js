...
const ContactComponent = props => {
    ...
    return (
        <View style={{ flex: 1, flexDirection: 'column', margin: 40, justifyContent: 'flex-start', }}>
            ...
            <Text>username: must be jeroh</Text>
            <Text>email: must be jerohnguyen@gmail.com</Text>
            <Field name="username" keyboardType="default" label="Username: " placeholder="Enter name" component={renderField} normalize={normalizeLower}                
            />
